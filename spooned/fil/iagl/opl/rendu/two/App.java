...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] spoonArgs = new String[]{ "-i" , ((inputDirectory + "\\src\\main\\java") + ";") + (INSTRUMENT_SOURCE_FOLDER) , "-o" , outputDirectory + "\\src\\main\\java" , "-p" , "fil.iagl.opl.rendu.two.processors.AddWatcherProcessor" , "--with-imports" };
