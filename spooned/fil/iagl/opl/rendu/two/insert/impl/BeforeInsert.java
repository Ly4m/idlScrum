...
public class BeforeInsert implements Insertion {
    ...
    public boolean match(CtElement element) {
        return (((element instanceof spoon.reflect.code.CtBreak) || (element instanceof spoon.reflect.code.CtReturn)) || (element instanceof spoon.reflect.code.CtThrow)) || (element instanceof spoon.reflect.code.CtContinue);
    }
